class MinHeap {
  ...
  heapifyDown() {
    ...
    while (this.hasLeftChild(index)) {
      ...
      if (this.hasRightChild(index) && this.rightChild(index).priorityScore < this.leftChild(index).priorityScore) {
        smallerChildIndex = this.getRightChildIndex(index);
      }

      if (this.heap[index].priorityScore < this.heap[smallerChildIndex].priorityScore) {
        break;
      } else {
